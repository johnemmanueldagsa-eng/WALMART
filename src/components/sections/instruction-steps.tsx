...
const steps: Step[] = [
  ...
  },
  {
    ...
    text: "Unlock your Walmart Rewards",
  },
];
...
export default function InstructionSteps() {
  ...
  return (
    <section className="relative w-full max-w-md mx-auto px-4 sm:px-5 mb-4 mt-3">
      <div className="relative rounded-[1.5rem] sm:rounded-[2rem] p-2 sm:p-4 bg-white/5 backdrop-blur-md border-2 border-[#0053e2]/25 shadow-[0_8px_32_rgba(234, 108, 2)] overflow-hidden group/box transition-all duration-500 hover:border-[#0053e2]/50 hover:scale-[1.01]">
        {/* Shimmer Effect */}
